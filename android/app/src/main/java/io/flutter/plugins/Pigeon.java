...
public class Pigeon {
  ...
  public interface ServiceApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, ServiceApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.ServiceApi.setLabelText", getCodec());
        if (api != null) {
